...
console.log(moneyReplace(0))
console.log(moneyReplace(1.23))
console.log(moneyReplace(1.234))
console.log(moneyReplace('1.234'))
console.log(moneyReplace('aaa'))
console.log(moneyReplace('1.2.3.444'))
